...
Charlie,35,Chicago`;
    ...
    it("should parse CSV and store in SQLite", async () => {
      ...
      const result = await parseAndStoreFile(TEST_PROJECT_ID, buffer, "test.csv", "text/csv");
...
13,14,15,16`;
  ...
  describe("Batch Processing", () => {
    ...
    it("should handle large CSV files with batching", async () => {
      ...
      const result = await parseAndStoreFile(TEST_PROJECT_ID, buffer, "large.csv", "text/csv");
